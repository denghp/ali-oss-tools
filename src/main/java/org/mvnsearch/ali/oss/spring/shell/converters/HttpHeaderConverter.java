 ...
 * @author denghp
 */
public class HttpHeaderConverter implements Converter<HttpHeader> {
    /**
    ...
    public boolean supports(Class<?> type, String optionContext) {
        return type.getCanonicalName().equals(HttpHeader.class.getCanonicalName());
    }
    ...
    public HttpHeader convertFromText(String value, Class<?> targetType, String optionContext) {
        Class<HttpHeader> enumClass = (Class<HttpHeader>) targetType;
        try {
            HttpHeader bucket = enumClass.newInstance();
    ...
    public boolean getAllPossibleValues(List<Completion> completions, Class<?> targetType, String existingData, String optionContext, MethodTarget target) {
        for (String candidate : HttpHeader.getDefaultNames()) {
